...
% NOTE:         Requires sub-section breakdowns
% ##################################################
...
% ?????
% POTENTIALLY BREAK DOWN VIA BULLET POINTS   -- Joseph (09/03)
% ?????

The initial meeting with the customer occurred on October 19th and was led by Ian Strachan and
served as the customer requirements elicitation meeting. The meeting
began with an overview of the ResDairy business (link to customer
section of report above) and the technologies currently in place. One
shortcoming of their existing system however is that the large quantity of big data gathered by ResDiary in their day-to-day operations is currently unused and dormant. 
