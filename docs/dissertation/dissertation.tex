...
% ################# Comment Log ####################
% I definitely would like to start stating the team used Scrum though the rest of this may not be necessary.
% ##################################################
...
Could have taken a purer scrum master role (rather than the hybrid scrum master - developer role) and established a product owner within the team. Conducted sprint planning meetings at the start of each sprint. Conducted sprint retrospective meetings at the end of each sprint. Sprint reviews were sort of conducted as we presented completed work to the customer and discussed incompleted work and the next sprint (sort of blended into the planning meeting which is bad)

Agile methods require discipline and effort to apply successfully. The team frequently laxed on our discipline and the result showed through the dropping of features, etc.

Lead in with a general why Agile...

As is often a common practice in industry (get a reference backing up claim) the team did not adhere strictly to one specfic agile framework. 

Instead the Scrum methodology was used as the overarching framework with additional practices from alternative methods, such as prototyping and extreme programming, being adopted as the team felt their use necessary and applicable.

While such behavior ensured a flexibile production environment  - and the team found moderate success in it but it was not without its issues.

Primary issue stemmed from lack of discipline to keep with all of the key Scrum methods (produce owner missing, mix of scrum master and developer role - partly due to nature of project in an academic setting, stand ups cancelled midway through semester one, reviews were light on reviewing incompleted work and instead focused on completed work.

Instead perhaps it would have been better to adopt additional Scrum extensions of backlog refinement and burn down charts in addition to having more defined roles and stand up meetings.
Reference throughout to relevant subsection reflection points tackling each specific issue.

Although the team did not conform to the Scrum practice of holding daily, or frequent, stand up meetings and the consequences of this practice are discussed at length in Section (reference lack of stand ups / poor communication).

Look into Scrumban and Agilo for Trac - did a light version informally but it would may have improved the process to got all out and use this.
...
Adhering to the advice of avoiding early commitment to a particular design solutions during the requirements elicitation process the team left the decision regarding the specific models and tool choice until after this was conducted. Although the requirements would evolve as the project developed, as is to be expected, the team felt with the correct initial system goals established the team could easily justify decision designs in relation to the key goals of the system. Details of such technical decisions are discussed in Section (reference technical decisions). 
...
I'd probably conclude that work worked best for us in the development cycle was the XP techniques and so the team should have adhered to that system closer.
...
% NOTE:         Temp notes / thoughts
% ################# Comment Log ####################
% I think this is best as a transision paragraph talking about the dangers of making decisions too early
% and so with that in mind here is the research and reflections of the key decsions that we made
