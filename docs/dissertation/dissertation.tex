...
% ##################################################
% LAST EDIT:  15/03/17  Joseph
% NOTE:         Technical Research Primarily Comes From That Section of Presentation
% NOTE:			Prototyping can be mentioned
% NOTE:			Statistical filter (feature discovery) can be mentioned
% ##################################################

% Probably needs complete rewrite but use parts in later sections
