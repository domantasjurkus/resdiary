...
% Section on technical choices containing the major decisions - Models / Python / Spark
...
% -> Where does testing section go (its kind of technical so do we do it at the start with technical decisions before more team focused reflections?) ???
% -> Can you think of a better order / structure ???
